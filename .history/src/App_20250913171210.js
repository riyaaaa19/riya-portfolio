  ...
  const projects = [
    {
      ...
      desc: "Full-stack app for managing employee leave requests with role-based access, JWT authentication, and real-time tracking.",
  ...
  return (
    <div>
        ...
        <section className="hero">
          ...
          <Particles
            ...
            options={{
              ...
              particles: {
                color: { value: "#ff4da6" },
                links: { color: "#ff4da6", distance: 120, enable: true, opacity: 0.3, width: 1 },
          ...
          <div className="hero-text">
            <h2>Hi There, I'm <span className="highlight">Riya Saraf</span></h2>
            <h3>I Am Into <span className="typing">Web Development | Data Science | AI/ML</span></h3>
            <p>
              Motivated Computer Science undergraduate skilled in Python, full-stack development, and ML/AI. 
              Passionate about building impactful solutions and open-source contributions.
            </p>
            <div style={{ marginTop: "20px" }}>
              <button className="cta" onClick={() => setActivePage("projects")}>View Projects</button>
              <button className="outline" onClick={() => setActivePage("contact")}>Contact Me</button>
            </div>
          ...
          <div className="hero-img">
            <div className="avatar-circle">
              <img src="/images/profile.png" alt="Riya Saraf" />
            </div>
          </div>
        </section>
      )}
      ...
      {activePage === "contact" && (
        <section>
          <h2>Contact</h2>
          <p>Email: <a href="mailto:riyasaraf19@gmail.com" style={{ color: "#ff4da6" }}>riyasaraf19@gmail.com</a></p>
          <p>LinkedIn: <a href="https://linkedin.com/in/riya-saraf-9223a9257" target="_blank" rel="noreferrer" style={{ color: "#ff4da6" }}>linkedin.com/in/riya-saraf</a></p>
          <p>GitHub: <a href="https://github.com/riyaaaa19" target="_blank" rel="noreferrer" style={{ color: "#ff4da6" }}>github.com/riyaaaa19</a></p>
        </section>
      )}

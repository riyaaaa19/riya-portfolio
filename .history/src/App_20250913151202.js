...
import TimelineCard from "./components/TimelineCard"; // adjust path if inside /components
    ...
    <div>
        ...
        <section>
          ...
          <div className="grid">
            {certificates.map((c, i) => (
              <TimelineCard key={i} title={c.title} img={c.img} icon="📜" type="certificate" />
            ))}
          </div>
        </section>
      )}
      ...
      {activePage === "awards" && (
        <section>
          ...
          <div className="grid">
            {awards.map((a, i) => (
              <TimelineCard key={i} title={a.title} img={a.img} icon="🏆" type="award" />
            ))}
          </div>
        </section>
      )}

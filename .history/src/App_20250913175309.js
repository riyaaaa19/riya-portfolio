    ...
    <div>
        ...
        <section className="hero">
          ...
          <div className="hero-img">
            <div className="avatar-circle">
              <img src="/images/riya.png" alt="Riya Saraf" />
            </div>
          </div>
        </section>
      )}
      ...
      {activePage === "projects" && (
        <section className="grid-section">
          ...
          <div className="grid-container">
            {projects.map((p, idx) => (
              <TimelineCard key={idx} {...p} type="project" />
            ))}
          </div>
        </section>
      )}
        ...
        <section className="grid-section">
          ...
          <div className="grid-container">
            {certificates.map((c, idx) => (
              <TimelineCard key={idx} {...c} type="certificate" />
            ))}
          </div>
        </section>
      )}
      ...
      {activePage === "awards" && (
        <section className="grid-section">
          ...
          <div className="grid-container">
            {awards.map((a, idx) => (
              <TimelineCard key={idx} {...a} type="award" />
            ))}
          </div>
        </section>
      )}
      ...
      {activePage === "contact" && (
        <section className="contact-section">
          ...
          <p>LinkedIn: <a href="https://linkedin.com/in/riya-saraf-9223a9257" target="_blank" rel="noreferrer">LinkedIn Profile</a></p>
          <p>GitHub: <a href="https://github.com/riyaaaa19" target="_blank" rel="noreferrer">GitHub Profile</a></p>
        </section>
      )}
    </div>
  );

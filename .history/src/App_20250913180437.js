  ...
  const education = [
    {
      ...
      year: "2022 – 2026",
      score: "CGPA: 8.28",
      img: "/images/graduation.png", // image for graduation
    },
    {
      ...
      img: "/images/school.png", // image for 12th
    },
    {
      school: "Nachiketa Higher Secondary School, Jabalpur",
      ...
      year: "2020",
      score: "Percentage: 92%",
      img: "/images/school.png", // image for 10th
    },
  ];
          ...
          <div className="timeline">
            {education.map((e, i) => (
              <TimelineCard
                ...
                year={e.year}
                score={e.score}
                img={e.img}      // Pass the image for the milestone
                type="education"
              />
            ))}
          </div>

      ...
      {activePage === "home" && (
        <section className="hero">
          <div className="hero-text">
            <h2>Hello, I'm <span className="highlight">Riya Saraf</span></h2>
            <h3>Full-Stack Developer & Data Science Enthusiast</h3>
            <p>
              Passionate about creating intuitive, impactful web solutions using Python, React,
      ...
      {activePage === "about" && (
        <section className="about">
          <div className="about-card">
            <img src="/images/riya-photo.png" alt="Riya Saraf" className="about-photo" />
            <div>
              <h2>About Me</h2>
              <p>
                I’m a Computer Science undergrad specializing in Data Science and Full-Stack
                Development. Skilled in Python, React, Django, and ML, I love building user-friendly
                interfaces and exploring innovative AI/ML solutions to solve real-world problems.
              </p>
            </div>
          </div>
        </section>

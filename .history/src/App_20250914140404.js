...
export default function RiyaSarafPortfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      desc: "Comprehensive health & wellness assistant for women with cycle tracking, journaling, PCOS risk assessment, AI-powered chatbot, and personalized recommendations.",

        ...
        <section className="about-section">
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "40px", alignItems: "center" }}>
            <div style={{ flex: 1, minWidth: "280px" }}>
              <p>
                Motivated Computer Science undergraduate with a strong academic record and consistent top performance.
                Skilled in Python, data analysis, and problem-solving, with a passion for building impactful tech solutions.
              </p>

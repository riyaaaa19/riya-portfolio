        ...
        <section className="about-section">
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "40px", alignItems: "center" }}>
            <div style={{ flex: 1, minWidth: "280px" }}>
              <p>
                “I’m a motivated Computer Science undergraduate with a consistent record of top academic performance and a deep interest in web development, 
                data science, and machine learning. 
                My technical toolkit spans Python, React.js, Django, FastAPI, and modern data-analysis libraries like Pandas and Scikit-learn.
                Beyond coding, I thrive in collaborative hackathons and problem-solving challenges, 
                where I’ve earned recognition for innovative solutions. I’m passionate about building AI-driven tools that solve real-world problems and improve user experiences.

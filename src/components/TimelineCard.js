      ...
      {type === "education" ? (
        <>
          <div style={contentStyle}>
            ...
            {subtitle && <p style={{ margin: "0 0 4px 0", color: "#666", fontSize: "14px" }}>{subtitle}</p>}
            {year && <p style={{ margin: "0 0 4px 0", fontSize: "13px", color: "#999" }}>{year}</p>}
            {score && <p style={{ margin: "0", fontSize: "13px", color: "#444" }}>{score}</p>}
          </div>
